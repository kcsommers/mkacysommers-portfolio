    ...
    <MainLayout
      ...
      leftContent={
        <div className="tablet-landscape-up:pr-16">
          <h3 className="font-marcellus text-3xl mt-8 mb-4">Hi, I'm Kacy!</h3>
          <p>
          ...
          <p className="">
            ...
            officially run out. I read Jon Duckett's JavaScript and JQuery cover
            to cover, buried myself in Youtube tutorials, and eventually signed
            up for a web development bootcamp in Seattle, WA. And even though my
            experience until then was not computer science focused, my artistic
            experiences prepared me well for the creative challenges of web
            development. I discovered quickly that my brain was well suited for
            the blend of logic and creativity that writing code requires, and
          ...
          <p className="">
            ...
            projects as a freelancer, contributing to or building from scratch a
            number of complex and unique applications. This additional work has
            helped me keep pace with the ever-changing landscape of front-end
            web development, and with every day and every google search I'm
            learning more and more. I couldn't be more grateful to work in a
            field that allows me to do just that.
          </p>
        </div>
      }
      rightContent={
